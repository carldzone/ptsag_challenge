...
from scraping_challenge.items import ScrapingChallengeItem
import regex as re
import datetime
...
class ScrapingSpider(scrapy.Spider):
    ...
    # url = 'https://rewardsforjustice.net/index/?jsf=jet-engine:rewards-grid&tax=crime-category:1070%252C1071%252C1073%252C1072%252C1074'
